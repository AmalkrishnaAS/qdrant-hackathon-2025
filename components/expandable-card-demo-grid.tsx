...
export default function ExpandableCardDemo({ cards }: ExpandableCardDemoProps) {
  ...
  return (
    <>
            ...
            >
              <motion.div layoutId={`image-${active.title}-${id}`}>
                <img
                  width={200}
                  height={200}
                  src={active.thumbnails.high.url}
                  alt={active.title}
                ...
                <div className="pt-4 relative px-4">
                  ...
                  >
                    <div className="flex flex-col gap-2">
                      ...
                      <p className="text-sm text-neutral-500">
                        Duration: {active.duration} • {active.category}
                      </p>
                    </div>
                  </motion.div>
                </div>
      ...
      <ul className="max-w-6xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-start gap-6 p-4">
          ...
          >
            <div className="flex gap-4 flex-col  w-full">
              ...
              <div className="flex justify-center items-center flex-col">
                ...
                <motion.p
                  layoutId={`description-${card.artists.join(', ')} • {card.album}-${id}`}
                  className="text-xs text-gray-400 line-clamp-2"
                >
                  {card.artists.join(', ')} • {card.album}
                </motion.p>
              </div>
            </div>
          </motion.div>
